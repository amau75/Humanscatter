...
extern const struct _mp_obj_module_t mp_module_backscatter_tag;
#undef MODULE_DEF_BACKSCATTER_TAG
#define MODULE_DEF_BACKSCATTER_TAG { MP_ROM_QSTR(MP_QSTR_backscatter_tag), MP_ROM_PTR(&mp_module_backscatter_tag) },
...
extern const struct _mp_obj_module_t mp_module_carrier_receiver;
#undef MODULE_DEF_CARRIER_RECEIVER
#define MODULE_DEF_CARRIER_RECEIVER { MP_ROM_QSTR(MP_QSTR_carrier_receiver), MP_ROM_PTR(&mp_module_carrier_receiver) },
...
#define MICROPY_REGISTERED_MODULES \
    MODULE_DEF_BACKSCATTER_TAG \
    MODULE_DEF_BUILTINS \
    MODULE_DEF_CARRIER_RECEIVER \
    MODULE_DEF_CMATH \
    MODULE_DEF_DEFLATE \
    MODULE_DEF_FRAMEBUF \
    MODULE_DEF_GC \
